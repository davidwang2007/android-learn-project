...
public abstract class ResultHandler {
	...
	private static final String[] EMAIL_TYPE_STRINGS = {"home", "work", "ROLE_MOBILE"};
	private static final String[] PHONE_TYPE_STRINGS = {"home", "work", "ROLE_MOBILE", "fax", "pager", "main"};
	...
	private String parseCustomSearchURL() {
		...
		String customProductSearch = prefs.getString("preferences_custom_product_search",
				null);
